...
# data_dir = "/Users/jorgeamaya/Desktop/Terra_Development/amplicon_decontamination_pipeline/Report/Merge/"
...
# missing_files = "/Users/jorgeamaya/Desktop/Terra_Development/amplicon_decontamination_pipeline/Results/missing_files.tsv"
...
contamination.report<-function(Name){
  ...
  if(is.na(b[1,1])){
    ...
    message<- message %>% rename("Observed Barcode Pair"="BarcodePair",
                                 "Fraction of Mergers"="V1",
                                 "Origin of Barcode Pair"="BarcodeOrigin")
...
```{r 'load libraries for plate scheme', echo=FALSE, results='hide'}
set.seed(123)
